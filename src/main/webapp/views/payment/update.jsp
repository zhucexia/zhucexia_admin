			...
			<table style="width: 100%;height:auto" class="CContent">
					<tbody>
						<tr>
							...
							<td><input type="text" name="name" value="${payment.name }"></input></td>
						...
						<tr>
							...
							<td><input type="text" name="payment_fee" value="${payment.payment_fee }"></td>
							<td><label>备注:</label></td>
							<td><input id="remark" type="text" name="remark" value="${payment.remark }"/></td>
						</tr>
						<tr>
							<td style="display:none;"><input id="id" type="text" name="id" value="${payment.id }"/></td>
				 ...
				 $.messager.confirm("操作提示", "您确定要执行修改吗？", function (data) {  
			            if (data) {  
			            	$("#updateform").form("submit", {    
			    			    url:"${root }/payment/updatepayment",  
			    			    onSubmit: function(){    
			    			        // do some check    
