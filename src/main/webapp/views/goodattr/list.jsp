	...
	<script language="javascript">
		$(function() {
			...
			queryDg = function() {
				...
				loadDg('${root}/goodattr/getGoodAttrList', params);
			};
			...
			editWhite = function() {
				...
				$("#editWin").window({
					...
					maximizable : false,
					minimizable : false,
					href : "${root}/goodattr/getgoodattr?id="+id,
					/* onClose : function() {
					...
					// $.messager.defaults = { ok: "是", cancel: "否" };  
				        ...
				        $.messager.confirm("操作提示", "您确定要执行删除吗？", function (data) {  
				            if (data) {  
								...
								$.ajax({
									url : "${root}/goodattr/deletegoodattr",
									type : 'POST',
									data : {
										"sno" : id
									},
